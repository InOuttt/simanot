            ...
            <x-slot name="body">
                <div >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="date" name="tanggal_covernote" class="form-control" placeholder="{{ __('dd/mm/yyyy') }}" value="{{ old('tanggal_covernote') }}" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="date" name="jatuh_tempo" class="form-control" placeholder="{{ __('dd/mm/yyyy') }}" value="{{ old('jatuh_tempo') }}" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="string" name="cluster" class="form-control" placeholder="{{ __('ex : Cluster') }}" value="{{ old('cluster') }}" maxlength="100" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="string" name="nama_dokumen" class="form-control" placeholder="{{ __('ex : dokumen piutang budi') }}" value="{{ old('nama_dokumen') }}" maxlength="255" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="string" name="nomor_tanggal_dokumen" class="form-control" placeholder="{{ __('ex : piutang/budi/xx/xx/xx') }}" value="{{ old('nomor_tanggal_dokumen') }}" maxlength="2255" />
                        </div>
                    </div>
<!-- 
                    <div class="form-group row">
