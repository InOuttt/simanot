        ...
        <x-backend.card>
            ...
            <x-slot name="body">
                <div >
                    ...
                    <div class="form-group row">
                        <label for="jangka_waktu" class="col-md-2 col-form-label">Jangka Waktu</label>

                        <div class="col-md-4">
                            <input type="number" id="jangka_waktu" name="jangka_waktu" class="form-control" placeholder="{{ __('... Hari') }}" value="{{ old('jangka_waktu') }}" maxlength="100" />
                        </div>
            ...
            <x-slot name="footer">
                <button class="btn btn-sm btn-primary float-right" type="submit">@lang('Buat Data Covernote')</button>
            </x-slot>
        </x-backend.card>
    </x-forms.post>
@endsection
