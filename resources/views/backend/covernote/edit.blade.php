...
@section('content')
    <x-forms.patch :action="route('covernote.update', $oldData)">
        <x-backend.card>
            <x-slot name="header">
            ...
            <x-slot name="body">
                <div >
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <livewire:notaris-select2 :idNotaris="$oldData->notaris_id"/>
                            <!-- <input type="text" name="name" class="form-control" placeholder="{{ __('Nama') }}" value="{{ $oldData->name }}" maxlength="100" required /> -->
                        </div>

                        <label for="tanggal_covernote" class="col-md-2 col-form-label">Tanggal Covernote</label>

                        <div class="col-md-4">
                            <input type="date" id="tanggal_covernote" name="tanggal_covernote" class="form-control" placeholder="{{ __('dd/mm/yyyy') }}" value="{{ $oldData->tanggal_covernote }}" />
                        </div>
                    </div><!--form-group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="no_covernote" class="form-control" placeholder="{{ __('ex : 123/abc/Jun/2021') }}" value="{{ $oldData->no_covernote }}" maxlength="100" />
                        </div>
                        <label for="jatuh_tempo" class="col-md-2 col-form-label">Jatuh Tempo</label>

                        <div class="col-md-4">
                            <input type="date" id="jatuh_tempo" name="jatuh_tempo" class="form-control" placeholder="{{ __('dd/mm/yyyy') }}" value="{{ $oldData->jatuh_tempo }}" />
                        </div>
                    </div><!--form-group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="number" id="durasi" name="durasi" class="form-control" placeholder="{{ __('... Hari') }}" value="{{ $oldData->durasi }}" maxlength="100" />
                        </div>
                        ...
                        <div class="col-md-4">
                            <select name="cluster_id">
                                ...
                                <option value="{{$cluster->id}}" {{$oldData->cluster_id == $cluster->id  ? 'selected' : ''}}>{{$cluster->nama}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="string" name="nama_debitur" class="form-control" placeholder="{{ __('ex : Budi si Debitur') }}" value="{{ $oldData->nama_debitur }}" maxlength="100" />
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_perpanjangan_sertifikat" id="flexRadioDefault1" value="0" {{$oldData->is_perpanjangan_sertifikat == 0  ? 'checked' : ''}}>
